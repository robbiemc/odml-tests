...
function monitorAvailability() {
  ...
  const summarizerAvailability = new SummarizerAvailability();
  summarizerAvailability.addEventListener('availabilitychanged', (e) => {
  ...
  summarizerAvailability.addEventListener('downloadprogress', (e) => {
    downloadProgress.value = e.detail.percent;
  });

  $('.download').addEventListener(
    'click',
    summarizerAvailability.downloadModel.bind(summarizerAvailability),
  );
}

class SummarizerAvailability extends EventTarget {
  ...
  async #checkAvailability() {
    ...
    if (window.Summarizer && Summarizer.availability) {
      newAvailability = await Summarizer.availability();
    }
